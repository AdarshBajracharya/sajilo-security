    ...
    if (shouldRemove) {
      deleteProductApi(id)
        .then((res) => {
          ...
          fetchProducts(); // Move fetchProducts here after delete success
        })
        .catch((err) => {
  ...
  return (
    <div className="listproduct">
      ...
      <div className="listproduct-header" style={{ display: "flex", gap: "1rem" }}>
        ...
        <a rel="stylesheet" href="/admin/dashboard/products/add">
        ...
        {allProducts.map((product, index) => (
          <div key={index}>
            <div className="listproduct-format">
              ...
              <p>
                <a rel="stylesheet" href={`/admin/dashboard/products/edit/${product._id}`}>
                  <button className="edit-product-button">Edit</button>
                </a>
                <button className="remove-product-button" onClick={() => removeProduct(product._id)}>
                  Delete
                </button>
              </p>
            </div>
